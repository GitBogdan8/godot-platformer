...
2. **Download:** Clone this repository using Git or click `Code` -> `Download ZIP` and extract it.
3. **Import:** - Open Godot Engine.
   - Click the **Import** button on the right side of the Project Manager.
   - Navigate to the project folder and select the `project.godot` file.
4. **Launch:** Once the editor opens, press **F5** (or the Play button in the top right) to start the game.
